...
def letter_case_count(string)
  lowercase_value = string.count('a-z')
  uppercase_value = string.count('A-Z')
  neither_value = string.count("^a-zA-Z")
  { lowercase: lowercase_value, uppercase: uppercase_value, neither: neither_value }
end
